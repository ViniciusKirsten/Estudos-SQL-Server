...
--PARA O COMANDO DO TIPO BIT, PODEMOS FAZER ENTRADAS COMO TRUE OU FALSE, OU TAMBÉM 1 OU 0.

--UM EXEMPLO DE FORMATO DE COMO TAMBEM PODEMOS INSERIR DADOS
